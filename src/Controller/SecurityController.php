...
class SecurityController extends AbstractController
{
  ...
  */
  public function inscription(Request $requeteHttp, ObjectManager $manager, UserPasswordEncoderInterface $encoder)
  {
    ...
    if ($formulaireUtilisateur->isSubmitted() && $formulaireUtilisateur->isValid()){
      ...
      // Attribuer le mot de passe encodé à l'utilisateur
